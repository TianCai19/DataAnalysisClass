# @Author: Your name
# @Date:   2020-12-10 08:35:03
# @Last Modified by:   Your name
# @Last Modified time: 2020-12-10 08:36:15
...
levels(xb)[as.integer(xb)] # levels(xb)是一个vector,
# 后面的as.integer(xb)是一个vector(记录)[1,2,1,,]
#[]用来访问向量
levels(xb)[xb]
#> [1] "女" "男" "男" "女" "男" "女"
